...
make_gridpack () {
    ...
    #Try newer version of MG
    MG=MG5_aMC_v3.6.2$MG_EXT
    MGSOURCE=https://launchpad.net/mg5amcnlo/3.0/3.6.x/+download/MG5_aMC_v3.6.2.tar.gz
    
    MGBASEDIRORIG=$(echo ${MG%$MG_EXT} | tr "." "_")
    #Preserve Original MG
    #mkdir $GEN_FOLDER/full_mg_backup
    #cp -a $MGBASEDIRORIG/ $GEN_FOLDER/full_mg_backup/
